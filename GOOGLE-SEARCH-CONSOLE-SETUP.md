# Google Search Console Setup — aztec.ketanshukla.com
...
1. Choose **"URL prefix"**
2. Enter: `https://aztec.ketanshukla.com`
3. Click **"Continue"**
...
2. Place it in `E:\aztec-samurai-Adventures\public\`
3. It will be accessible at `https://aztec.ketanshukla.com/googleXXXXXXXXXXXXXXXX.html`
...
2. Enter: `sitemap.xml`
3. Click **"Submit"**
4. Full URL: `https://aztec.ketanshukla.com/sitemap.xml`

### Step 5: Request Indexing

1. In the left sidebar, click **"URL Inspection"**
2. Paste: `https://aztec.ketanshukla.com/`
...
|-----|----------|-----------------|
| `https://aztec.ketanshukla.com` | 1.0 | monthly |
...
Sitemap: https://aztec.ketanshukla.com/sitemap.xml
```
