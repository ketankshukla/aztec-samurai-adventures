# Generate ebook covers via OpenAI API
# Reads prompts from book-prompts\ebook-covers\, outputs to book-images\api-ebook-covers\
...
$promptDir = "E:\aztec-samurai-adventures\book-prompts\ebook-covers"
$outDir = "E:\aztec-samurai-adventures\book-images\api-ebook-covers"
